...
//        if (day == 1) {
//            Picasso.get().load("https://i.pinimg.com/564x/bf/4f/9a/bf4f9ae96ea48423208f30b830bf5319.jpg").into(backimg);
//        } else {
//            Picasso.get().load("https://images.unsplash.com/photo-1577132161035-1a187871ec13?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80").into(backimg);
//        }
